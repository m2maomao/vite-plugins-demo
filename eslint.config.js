...
export default tseslint.config(
  { ignores: ['**/dist/**', '**/node_modules/**', '**/*.d.ts', '**/*.js', '**/*.cjs', '**/*.mjs', '**/create-deer-mobile/template/**', '**/server/index.ts', '**/vitest.config.*', 'vitest.workspace.ts', '**/playwright.config.*', '**/test/visual/**', 'docs/**'] },
