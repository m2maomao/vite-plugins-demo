...
const actionSheetProps = computed(() => {
  ...
  const keys: (keyof typeof props)[] = [
    'actions', 'title', 'cancelText', 'description',
    'closeable', 'closeIcon', 'closeOnClickAction',
    'round', 'closeOnPopstate', 'safeAreaInsetBottom',
    'closeOnClickOverlay', 'lockScroll', 'teleport',
  ]
