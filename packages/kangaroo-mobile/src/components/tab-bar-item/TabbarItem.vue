<template>
  ...
  <VanTabbarItem v-bind="itemProps" @click="emit('click', $event)">
    <template #icon="iconProps">
      <YhmIcon v-if="iconProps.active && props.activeIcon" :name="props.activeIcon" :size="props.iconSize" />
      <YhmIcon v-else-if="props.icon" :name="props.icon" :size="props.iconSize" />
...
const itemProps = computed(() => {
  const { icon, activeIcon, iconSize, ...rest } = props;
