...
const tabsProps = computed(() => {
  ...
  const keys: (keyof typeof props)[] = [
    'type', 'color', 'border', 'sticky', 'shrink', 'duration',
    'animated', 'ellipsis', 'swipeable', 'scrollspy', 'offsetTop',
    'background', 'lazyRender', 'showHeader', 'lineWidth', 'lineHeight',
    'beforeChange', 'swipeThreshold', 'titleActiveColor', 'titleInactiveColor',
  ]
