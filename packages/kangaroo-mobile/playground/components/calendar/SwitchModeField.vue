...
<template>
  <demo-block card :title="t('switchMode')">
    <van-cell is-link :title="t('switchMode')" :value="switchMode" @click="onClickField" />
    <van-popup v-model:show="showPicker" round position="bottom">
      <van-picker :columns="switchModeColumns" @cancel="onPickerCancel" @confirm="onPickerConfirm" />
    </van-popup>
  </demo-block>
</template>
