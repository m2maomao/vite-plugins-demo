...
<template>
  <div class="demo-picker">
    ...
    <demo-block card :title="t('modelValue')">
      <yhm-picker v-model="selectedValues" :title="t('title')" :columns="curBasic" show-toolbar />
    </demo-block>

    <demo-block card :title="t('multipleColumns')">
      <yhm-picker :title="t('title')" :columns="curDate" show-toolbar @cancel="onCancel" @confirm="onConfirm" />
    </demo-block>
    ...
    <demo-block card :title="t('customChildrenKey')">
      <yhm-picker :title="t('title')" :columns="curCustomKey" :columns-field-names="customFieldName" show-toolbar />
    </demo-block>
  </div>
</template>
