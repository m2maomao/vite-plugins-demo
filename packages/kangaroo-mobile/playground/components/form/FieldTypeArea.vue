...
<template>
  <yhm-field
    ...
    @click="showArea = true" />
  <van-popup v-model:show="showArea" destroy-on-close round position="bottom" teleport="body">
    <yhm-area :area-list="currentAreaList" :model-value="pickerValue" @confirm="onConfirm" @cancel="onCancel" />
  </van-popup>
</template>
